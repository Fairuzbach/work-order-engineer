    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')"
                required autocomplete="username" placeholder="JohnDoe@mail.com" />
        ...
        <div class="mt-4" x-data="{ show: false }">
            ...
            <div class="relative">
                <x-text-input id="password" class="block mt-1 w-full pr-10" ::type="show ? 'text' : 'password'" name="password"
        ...
        <div class="mt-4" x-data="{ show: false }">
            ...
            <div class="relative">
                <x-text-input id="password_confirmation" class="block mt-1 w-full pr-10" ::type="show ? 'text' : 'password'"
